        ...
        return this.dataFilm.map((film,index)=>{
                return <div className="col-4 mt-2" key={index}>
                        <div className="card text-white bg-primary">
                            <img className="card-img-top" src={film.hinhAnh} alt style={{width:'100%',height:'300px'}} />
                            <div className="card-body">
                                <h4 className="card-title"style={{height:50}}>{film.tenPhim}</h4>
                                <p className="card-text" style={{height:100}}>{film.moTa.length > 150 ? film.moTa.substr(0,150) +'...' : film.moTa}</p>
                            </div>
                        </div>
                    </div>
    ...
    render() {
        return (
            <div className="container">
               <h3 className="text-center my-4">Bai tap quan ly phim</h3>
               <div className="row">
                   {this.renderFilm()}
               </div>
